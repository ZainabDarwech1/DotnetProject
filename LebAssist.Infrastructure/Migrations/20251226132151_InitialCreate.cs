        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProviderAvailabilities_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PortfolioPhotoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderPortfolios", x => x.PortfolioPhotoId);
                    table.ForeignKey(
                        name: "FK_ProviderPortfolios_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ServiceIconPath = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_Clients_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmergencyRequests_Clients_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmergencyRequests_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "ServiceId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProviderServices_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderWorkingHours", x => x.WorkingHourId);
                    table.ForeignKey(
                        name: "FK_ProviderWorkingHours_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProviderWorkingHours_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "ServiceId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportedProviderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_Clients_ReportedProviderId",
                        column: x => x.ReportedProviderId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_Clients_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_IsProvider",
                table: "Clients",
                column: "IsProvider");

            migrationBuilder.CreateIndex(
                name: "IX_Clients_ProviderStatus",
                table: "Clients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_ProviderId",
                table: "EmergencyRequests",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_ServiceId",
                table: "EmergencyRequests",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderPortfolios_ClientId",
                table: "ProviderPortfolios",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ProviderServices_ClientId",
                table: "ProviderServices",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ProviderServices_ClientId_ServiceId",
                table: "ProviderServices",
                columns: new[] { "ClientId", "ServiceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProviderServices_IsActive",
                table: "ProviderServices",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderWorkingHours_ClientId",
                table: "ProviderWorkingHours",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ProviderWorkingHours_ServiceId",
                table: "ProviderWorkingHours",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_ReportedProviderId",
                table: "Reports",
                column: "ReportedProviderId");
